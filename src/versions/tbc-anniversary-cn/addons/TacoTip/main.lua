...
local function normalizeLocaleFontConfig()
    if (not TacoTipConfig or GetLocale() ~= "zhCN") then
        return
    end

    if (not TacoTipConfig.tooltip_font or TacoTipConfig.tooltip_font == "Fonts\\FRIZQT__.TTF" or TacoTipConfig.tooltip_font == "Fonts\\FRIZQT_.TTF") then
        TacoTipConfig.tooltip_font = "Fonts\\ZYHei.TTF"
    end
end
