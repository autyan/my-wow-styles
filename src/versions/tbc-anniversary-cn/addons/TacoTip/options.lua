...
function TT:GetDefaults()
    local defaultTooltipFont = "Fonts\\FRIZQT__.TTF"
    local locale = GetLocale and GetLocale()
    if (locale == "zhCN") then
        defaultTooltipFont = "Fonts\\ZYHei.TTF"
    elseif (locale == "zhTW") then
        defaultTooltipFont = "Fonts\\bHEI01B.TTF"
    elseif (locale == "koKR") then
        defaultTooltipFont = "Fonts\\2002.TTF"
    end
    ...
    return {
        ...
        tooltip_font = defaultTooltipFont,
